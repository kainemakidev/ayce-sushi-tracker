        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1">
              <p className="text-sm font-bold text-gray-900 truncate">{meal.restaurantName}</p>
              {topAchievement && (
            ...
            <div className="grid grid-cols-3 gap-2">
              <div>
                ...
                <p className="text-sm font-semibold text-gray-700">{formatCurrency(meal.aycePrice)}</p>
              </div>
              <div>
